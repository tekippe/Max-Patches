...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 278.0, 155.5, 20.0 ],
					"text" : "save it as a wave file"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 23.0, 7.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.0, 278.0, 111.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 224.0, 57.5, 20.0 ],
					"text" : "make 1D"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.0, 197.0, 175.5, 20.0 ],
					"text" : "scale range to -1..1 for audio"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.0, 167.0, 155.5, 20.0 ],
					"text" : "fit range to 0..1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 347.0, 75.0, 150.0, 20.0 ],
					"text" : "seed for noise terrains"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 303.0, 62.0, 22.0 ],
					"text" : "writewave"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 75.0, 155.5, 20.0 ],
					"text" : "choose a basis function"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.5, 51.0, 150.0, 20.0 ],
					"text" : "scale the terrain output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 53.0, 49.0, 150.0, 20.0 ],
					"text" : "click to generate a terrain"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 321.5, 197.0, 150.0, 150.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 272.0, 51.0, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.0, 97.0, 70.0, 22.0 ],
					"text" : "scale $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 38.0, 254.5, 275.0, 13.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 366.0, 448.5, 87.0 ],
					"ruler" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 303.0, 149.0, 22.0 ],
					"text" : "loadmess samps 1048576"
				}
...
,
					"patching_rect" : [ 23.0, 197.0, 41.0, 22.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 23.0, 167.0, 73.0, 22.0 ],
					"text" : "jit.normalize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 23.0, 138.0, 349.0, 22.0 ],
					"text" : "jit.bfg 1 float32 1024 1024 @scale 2 2 @basis fractal.turbulence"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 23.0, 223.0, 181.0, 22.0 ],
					"text" : "jit.scanwrap 1 float32 1048576 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 337.5, 116.0, 22.0 ],
					"text" : "jit.buffer~ landscape"
				}
...
, 			{
				"box" : 				{
					...
					"bufsize" : 256,
					"calccount" : 9,
					"fgcolor" : [ 0.0, 1.0, 0.082352941176471, 1.0 ],
					"gridcolor" : [ 0.0, 0.909803921568627, 1.0, 0.0 ],
					"id" : "obj-24",
					"maxclass" : "scope~",
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 382.5, 270.0, 128.0, 128.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 347.0, 97.0, 101.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ "seed", 74 ],
							"parameter_initial_enable" : 1,
							"parameter_invisible" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 38.0, 97.0, 225.5, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ "basis", "fractal.turbulence" ],
							"parameter_initial_enable" : 1,
							"parameter_invisible" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 32.5, 192.0, 331.0, 192.0 ],
					"order" : 0,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 356.5, 128.0, 32.5, 128.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 47.5, 128.0, 32.5, 128.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 281.5, 128.0, 32.5, 128.0 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 173.5, 330.75, 32.5, 330.75 ],
					"source" : [ "obj-36", 0 ]
				}

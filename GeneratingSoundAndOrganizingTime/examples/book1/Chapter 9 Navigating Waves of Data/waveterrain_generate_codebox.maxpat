...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 249.5, 17.0, 62.0, 22.0 ],
					"text" : "writewave"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 445.0, 23.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 41.5, 102.0, 448.5, 87.0 ],
					"ruler" : 0,
					"selectioncolor" : [ 0.27843137254902, 0.27843137254902, 0.23921568627451, 0.0 ],
					"setunit" : 1,
...
,
						...
						"tags" : "",
						"style" : "",
						"subpatcher_template" : "oopsy-gen-design",
						"assistshowspatchername" : 0,
						"boxes" : [ 							{
								"box" : 								{
									"id" : "obj-2",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 493.5, 90.5, 56.0, 22.0 ],
									"text" : "history N"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 493.5, 59.5, 29.0, 22.0 ],
									"text" : "sqrt"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 493.5, 30.5, 76.0, 22.0 ],
									"text" : "buffer terrain"
								}
...
, 							{
								"box" : 								{
									"code" : "fxy(x, y) {\r\n\tx1 = x*2-1;\r\n\tx2 = tanh(sin(twopi*x*(1+y))+sin(4*pi*x));\r\n\treturn mix(x1, x2, y);\r\n}\r\n\r\nif (elapsed == 1) {\r\n\tfor (i=0; i<N; i+=1) {\r\n\t\tfor (j=0; j<N; j+=1) {\r\n\t\t\t// normalized X and Y coordinates:\r\n\t\t\tx = j/N;\r\n\t\t\ty = i/N;\r\n\t\t\t// compute Z according to X and Y:\r\n\t\t\tz = fxy(x, y);\t\r\n\t\t\t// sample index into the buffer:\t\t\r\n\t\t\tindex = j + i*N;\t\r\n\t\t\t// write to the buffer\r\n\t\t\tpoke(terrain, z, index);\r\n\t\t}\r\n\t}\r\n}",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 32.0, 30.5, 452.5, 345.5 ]
								}
...
,
					"patching_rect" : [ 41.5, 23.0, 144.0, 22.0 ],
					"text" : "gen~ @title create-terrain"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 249.5, 46.0, 178.0, 22.0 ],
					"text" : "buffer~ terrain @samps 262144"
				}

...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.0, 47.5, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 178.0, 74.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 178.0, 124.0, 59.0, 22.0 ],
					"text" : "random 8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 365.5, 207.0, 150.0, 20.0 ],
					"text" : "multiplier"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.0, 149.5, 346.0, 33.0 ],
					"text" : "even numbers will give power-of-2 subdivisions\nodd numbers will give triplet/dotted subdivisions"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 303.0, 276.0, 500.0, 90.0 ],
					"range" : [ -0.1, 1.1 ],
					"rounded" : 0.0,
					"samples" : 200000.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 811.0, 346.0, 99.0, 20.0 ],
					"text" : "Ratcheted beat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 811.0, 402.0, 99.0, 20.0 ],
					"text" : "Beat (1/4 note)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 303.0, 368.0, 500.0, 54.0 ],
					"range" : [ -0.1, 1.1 ],
					"rounded" : 0.0,
					"samples" : 200000.0
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 178.0, 306.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 179.5, 452.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 18.5, 306.0, 48.0, 136.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ -70 ],
							"parameter_initial_enable" : 1,
...
,
									"patching_rect" : [ 28.0, 103.0, 87.0, 22.0 ],
									"text" : "gen @title kick"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 28.0, 27.0, 55.0, 22.0 ],
									"text" : "in 1 beat"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 28.0, 155.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 37.5, 139.5, 37.5, 139.5 ],
									"source" : [ "obj-10", 0 ]
								}
...
,
					"patching_rect" : [ 18.5, 276.0, 94.0, 22.0 ],
					"text" : "gen~ @title kick"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 303.0, 207.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 326.0, 32.0, 256.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 86.0, 73.5, 76.0, 22.0 ],
									"text" : "go.ramp2trig"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 270.0, 154.0, 100.0, 60.0 ],
...
,
					"patching_rect" : [ 178.0, 207.0, 116.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 178.0, 155.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 452.0, 45.0, 45.0 ]
				}

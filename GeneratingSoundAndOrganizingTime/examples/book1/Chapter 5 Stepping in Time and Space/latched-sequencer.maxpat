...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 32.0, 150.0, 20.0 ],
					"text" : "Sample & Hold melodies"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 344.0, 55.0, 39.0, 22.0 ],
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 344.0, 18.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 13.5, 69.0, 33.0 ],
					"text" : "Resync phasors"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 382.0, 150.0, 20.0 ],
					"text" : "Sample & hold melody"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 290.0, 150.0, 20.0 ],
					"text" : "Trigger"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 197.0, 150.0, 20.0 ],
					"text" : "Source"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 26.0, 220.0, 184.0, 68.0 ],
					"range" : [ -0.1, 1.1 ],
					"rounded" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 26.0, 312.0, 184.0, 68.0 ],
					"range" : [ -0.1, 1.1 ],
					"rounded" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 26.0, 127.0, 184.0, 68.0 ],
					"range" : [ -0.1, 1.1 ],
					"rounded" : 0.0
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 426.0, 25.0, 56.0, 22.0 ],
									"text" : "in 1 sync"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 265.0, 25.0, 98.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 34.0, 25.0, 83.0, 22.0 ],
									"text" : "param lfoHz 5"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 137.0, 146.0, 77.0, 22.0 ],
									"text" : "out 2 melody"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 265.0, 146.0, 55.0, 22.0 ],
									"text" : "out 3 trig"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 34.0, 80.5, 40.0, 22.0 ],
									"text" : "go.lfo"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 1 ],
									"hidden" : 1,
									"midpoints" : [ 435.5, 51.0, 69.5, 51.0 ],
									"order" : 1,
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 1 ],
									"hidden" : 1,
									"midpoints" : [ 435.5, 51.0, 300.5, 51.0 ],
									"order" : 0,
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 0 ],
									"midpoints" : [ 43.5, 110.75, 146.5, 110.75 ],
									"order" : 0,
									"source" : [ "obj-6", 0 ]
								}
...
,
					"patching_rect" : [ 26.0, 87.0, 300.5, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 278.5, 163.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 278.5, 306.0, 45.0, 45.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 85.000030000000038, 147.0, 40.0, 22.0 ],
									"text" : "*~ 0.3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 85.000030000000038, 181.0, 83.0, 22.0 ],
									"text" : "gen~ freeverb"
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 46.0, 83.984375, 30.0, 22.0 ],
													"text" : "* 12"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 46.0, 235.0, 36.0, 22.0 ],
													"text" : "cycle"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 46.0, 208.1875, 32.0, 22.0 ],
													"text" : "mtof"
												}
...
,
									"patching_rect" : [ 40.000030000000038, 106.0, 36.0, 22.0 ],
									"text" : "gen~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 40.000030000000038, 40.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 85.000030000000038, 40.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 40.000030000000038, 245.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 73.000030000000038, 245.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 239.5, 127.0, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 26.0, 57.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 185.0, 57.0, 150.0, 22.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 194.5, 82.5, 35.5, 82.5 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 353.5, 82.5, 35.5, 82.5 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 317.0, 117.5, 317.0, 117.5 ],
					"order" : 0,
					"source" : [ "obj-4", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 176.25, 117.5, 249.0, 117.5 ],
					"order" : 0,
					"source" : [ "obj-4", 1 ]
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/Gen_Patches/genbook/examples/part1/Chapter 5 Stepping in Time and Space",
				"patcherrelativepath" : ".",
				"type" : "gDSP",
				"implicit" : 1
			}

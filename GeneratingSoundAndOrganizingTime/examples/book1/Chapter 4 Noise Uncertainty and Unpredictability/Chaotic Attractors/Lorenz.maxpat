...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 597.2999999999995, 260.0, 120.0, 20.0 ],
					"text" : "X Y Z average",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 597.2999999999995, 114.0, 120.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 29.299999999999727, 21.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 408.299999999999443, 390.0, 120.0, 20.0 ],
					"text" : "X / Z",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.299999999999443, 390.0, 120.0, 20.0 ],
					"text" : "Y / Z",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.299999999999457, 390.0, 120.000000000000284, 20.0 ],
					"text" : "X / Y",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 408.299999999999443, 265.0, 120.0, 120.0 ],
					"range" : [ -1.01, 1.01 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 219.299999999999443, 265.0, 120.0, 120.0 ],
					"range" : [ -1.01, 1.01 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 408.299999999999443, 114.0, 120.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 219.299999999999443, 114.0, 120.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 30.299999999999727, 114.0, 120.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 30.299999999999727, 265.0, 120.0, 120.0 ],
					"range" : [ -1.01, 1.01 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 21.0, 50.0, 22.0 ],
					"text" : "reset"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 91.0, 88.0, 212.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 339.75, 190.0, 22.0, 22.0 ],
									"text" : "/ 3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 339.75, 218.0, 58.0, 22.0 ],
									"text" : "out 4 avg"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 171.0, 218.0, 46.0, 22.0 ],
									"text" : "out 2 Y"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 251.0, 218.0, 46.0, 22.0 ],
									"text" : "out 3 Z"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 251.0, 155.0, 70.0, 22.0 ],
									"text" : "go.autolimit"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 171.0, 155.0, 70.0, 22.0 ],
									"text" : "go.autolimit"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 91.0, 121.0, 179.0, 22.0 ],
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 100.5, 185.5, 349.25, 185.5 ],
									"order" : 0,
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-28", 0 ],
									"midpoints" : [ 180.5, 185.5, 349.25, 185.5 ],
									"order" : 0,
									"source" : [ "obj-7", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-28", 0 ],
									"midpoints" : [ 260.5, 185.5, 349.25, 185.5 ],
									"order" : 0,
									"source" : [ "obj-8", 0 ]
								}
...
,
					"patching_rect" : [ 29.299999999999727, 72.0, 586.999999999999773, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 201.5, 62.0, 38.799999999999727, 62.0 ],
					"source" : [ "obj-8", 0 ]
				}
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/_genbook_git/patchers",

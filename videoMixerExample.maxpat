...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 651.0, 440.0, 228.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "2toner",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 264.0, 34.0, 40.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "dial",
							"parameter_mmax" : 4999.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 543.0, 372.5, 40.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 264.0, 81.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 378.0, 398.5, 125.0, 34.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 542.0, 577.0, 216.0, 138.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 378.0, 449.0, 118.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "xfadr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 585.0, 289.0, 216.0, 138.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 578.0, 152.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 578.0, 117.0, 59.0, 22.0 ],
					"text" : "random 3"
				}
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "/Volumes/beige/MediaToScreen/Maya Deren Experimental Films.m4v",
								"filename" : "Maya Deren Experimental Films.m4v",
								"filekind" : "moviefile",
								"id" : "u331003039",
								"loop" : 0,
								"content_state" : 								{
...
,
					...
					"output_texture" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 578.0, 185.0, 506.0, 94.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 58.0, 42.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 58.0, 81.0, 63.0, 22.0 ],
					"text" : "metro 300"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 58.0, 117.0, 59.0, 22.0 ],
					"text" : "random 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 58.0, 289.0, 216.0, 138.0 ],
					"sync" : 1
				}
...
,
					...
					"output_texture" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 58.0, 185.0, 506.0, 94.0 ]
				}
...
, 			{
				"name" : "dennis.mp4",
				"bootpath" : "~/Music/Ableton/Factory Packs/Building Max Devices/Part 4 - Examples/Visuals/Video Slicer/Samples",
				"patcherrelativepath" : "../../Music/Ableton/Factory Packs/Building Max Devices/Part 4 - Examples/Visuals/Video Slicer/Samples",
				"type" : "mpg4",
				"implicit" : 1
			}
, 			{
